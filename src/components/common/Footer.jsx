...
<div className="bg-richblack-800">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-8 md:py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          {/* Section 1 */}
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-full sm:w-[48%] lg:w-[30%] flex flex-col gap-3 mb-7 lg:pl-0">
              <img src={Logo || "/placeholder.svg"} alt="TechAscend Logo" className="object-contain w-32 sm:w-40" />
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between pl-3 lg:pl-5 gap-3 mt-8 lg:mt-0">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-8 md:pb-14 text-sm gap-4 lg:gap-0">
        {/* Section 1 */}
        <div className="flex justify-center lg:justify-start items-center flex-col lg:flex-row gap-3 w-full lg:w-auto">
        ...
        <div className="text-center lg:text-right">Made with ❤️ Tech Classes</div>
      </div>
    </div>
  )
}
